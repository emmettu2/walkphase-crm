...
export const SEED_ORGANIZATIONS: Organization[] = [
  ...
  // Wave 2026-04-16 to 2026-04-22 outreach
  {
    id: 'org-bloomington-mn', organization_name: 'City of Bloomington, MN',
    target_category: 'city', organization_type_detail: 'City Government — Civil Engineering/Traffic',
    website: 'https://www.bloomingtonmn.gov', location_city: 'Bloomington', location_state: 'MN', region: 'Midwest',
    notes: '$400K SS4A Planning & Demo (FY24). Covered by Hennepin County Action Plan ($200K FY22). Amy Marohn has 22 years in traffic engineering at Bloomington.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'planning_demo_candidate', underserved_community_relevance: 'medium',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Eligible for Implementation through Hennepin County Action Plan. Amy liked an SS4A planning post — active signal.',
    source: 'LinkedIn', created_at: '2026-04-16T10:00:00Z', updated_at: '2026-04-16T10:00:00Z',
  },
  {
    id: 'org-dvrpc', organization_name: 'Delaware Valley Regional Planning Commission',
    target_category: 'mpo', organization_type_detail: 'Metropolitan Planning Organization — Philadelphia region',
    website: 'https://www.dvrpc.org', location_city: 'Philadelphia', location_state: 'PA', region: 'Mid-Atlantic',
    notes: '$4M+ SS4A across Action Plan + P&D (FY22, FY24, FY25). City of Philadelphia has $53.6M in implementation. Jen Farris is Transportation Planner, Office of Transit, Bike & Ped — UNC HSRC research background on nighttime pedestrian fatalities.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'yes', action_plan_type: 'ss4a_action_plan',
    ss4a_stage: 'active_grantee', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Jen Farris has UNC HSRC research background on nighttime pedestrian fatalities (AAA published). Perfect research-informed contact at active SS4A MPO.',
    source: 'LinkedIn, SS4A Award Data', created_at: '2026-04-16T10:00:00Z', updated_at: '2026-04-16T10:00:00Z',
  },
  {
    id: 'org-vta', organization_name: 'Santa Clara Valley Transportation Authority (VTA)',
    target_category: 'mpo', organization_type_detail: 'Transit + Congestion Management Agency',
    website: 'https://www.vta.org', location_city: 'San Jose', location_state: 'CA', region: 'West Coast',
    notes: 'Regional transit + CMA for Santa Clara County. San Jose has $21.4M SS4A. Lauren Ledbetter leads Bike & Pedestrian Program + Complete Streets. John Sighamony is Transportation Planner.',
    had_prior_ss4a_grant: 'no', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'likely_planning_candidate', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Two contacts (Lauren + John) — pincer strategy. Lauren has 12+ years at VTA + 8 years at Alta Planning (major planning consultancy). Deep Complete Streets expertise.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'org-clackamas', organization_name: 'Clackamas County',
    target_category: 'county', organization_type_detail: 'County Government — Transportation Planning',
    website: 'https://www.clackamas.us', location_city: 'Oregon City', location_state: 'OR', region: 'Pacific Northwest',
    notes: '$300K SS4A Planning & Demo (FY23). City of Portland has $29.6M. Jeff Owen is Principal Planner — 9 years at TriMet including Active Transportation Planner, plus HDR consulting background.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'planning_demo_candidate', underserved_community_relevance: 'medium',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Jeff has rare mix — active transportation + consulting + transit planning. Portland metro area is pedestrian-focused region.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'org-metroplan-orlando', organization_name: 'MetroPlan Orlando',
    target_category: 'mpo', organization_type_detail: 'Metropolitan Planning Organization',
    website: 'https://metroplanorlando.gov', location_city: 'Orlando', location_state: 'FL', region: 'Southeast',
    notes: '$5.9M SS4A (FY22-24) Action Plan + Planning & Demo. Covers Orlando metro. City of Orlando has $8.3M pedestrian-related SS4A. Mighk Wilson is Bike/Ped Planner.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'yes', action_plan_type: 'ss4a_action_plan',
    ss4a_stage: 'active_grantee', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Orlando pincer opportunity — MPO has Action Plan, cities (Kissimmee, Sanford, Winter Park) are eligible through it. Mighk is bike/ped planner — direct WalkPhase fit.',
    source: 'LinkedIn, SS4A Award Data', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'org-yakima', organization_name: 'Yakima County',
    target_category: 'county', organization_type_detail: 'County Government — Transportation Planning',
    website: 'https://www.yakimacounty.us', location_city: 'Yakima', location_state: 'WA', region: 'Pacific Northwest',
    notes: 'Yakima Valley Conference of Governments got $300K SS4A Planning & Demo (FY23). Yakima County itself hasn\'t applied. Deb LaCombe is Senior Transportation Planner.',
    had_prior_ss4a_grant: 'no', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'likely_planning_candidate', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'medium', university_research_strength: 'not_applicable', grant_partner_fit: 'medium',
    strategic_notes: 'Agricultural region, underserved communities. No prior county SS4A = new entrant advantage.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'org-arc', organization_name: 'Atlanta Regional Commission',
    target_category: 'mpo', organization_type_detail: 'Metropolitan Planning Organization — Mobility Services',
    website: 'https://atlantaregional.org', location_city: 'Atlanta', location_state: 'GA', region: 'Southeast',
    notes: '$3M SS4A Planning & Demo (FY24). Atlanta region has $44M+ total SS4A. Bennett Foster is Managing Director of Mobility Services — bike/ped advocacy background.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'planning_demo_candidate', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Atlanta pincer: Bill Curtis-Davidson (Georgia Tech CIDI) + Kari Watkins (Georgia Tech) + Bennett (ARC). Regional MPO covering Atlanta metro.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'org-bellevue', organization_name: 'City of Bellevue, WA',
    target_category: 'city', organization_type_detail: 'City Government — Transportation',
    website: 'https://bellevuewa.gov', location_city: 'Bellevue', location_state: 'WA', region: 'Pacific Northwest',
    notes: '$2.7M SS4A (managed by Akshali Gandhi until May 2025 — she has since moved on). Covered by Puget Sound Regional Council Action Plan.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'active_grantee', underserved_community_relevance: 'medium',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Major SS4A grantee. Akshali Gandhi left in May 2025 — may have deep insight into how SS4A grants are managed from inside. Fulbright scholar on street design for kids.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'org-montgomery-md', organization_name: 'Montgomery County, MD',
    target_category: 'county', organization_type_detail: 'County Government — Dept of Transportation, Traffic Engineering & Operations',
    website: 'https://www.montgomerycountymd.gov', location_city: 'Gaithersburg', location_state: 'MD', region: 'Mid-Atlantic',
    notes: '$700K+ SS4A Planning & Demo across Montgomery County + Gaithersburg. Charles Freeman (PE, PTP) is Senior Planning Specialist managing Vision Zero High Injury Network Road Safety Audits + Safe Routes to School.',
    had_prior_ss4a_grant: 'yes', has_action_plan: 'no', action_plan_type: 'unknown',
    ss4a_stage: 'planning_demo_candidate', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'Charles is literally running Road Safety Audits on High Injury Network — that\'s exactly where WalkPhase data belongs. Prime technical contact.',
    source: 'LinkedIn, SS4A Award Data', created_at: '2026-04-22T10:00:00Z', updated_at: '2026-04-22T10:00:00Z',
  },
  {
    id: 'org-martin-fl', organization_name: 'Martin County',
    target_category: 'county', organization_type_detail: 'County Government — Community Redevelopment Agency',
    website: 'https://www.martin.fl.us', location_city: 'Stuart', location_state: 'FL', region: 'Southeast',
    notes: 'NO prior SS4A funding — new entrant advantage in FY26. Treasure Coast region north of Palm Beach. Joy Puerta is CRA Program Manager, previously 5 years at Martin MPO where she built the Vision Zero Action Plan.',
    had_prior_ss4a_grant: 'no', has_action_plan: 'yes', action_plan_type: 'vision_zero',
    ss4a_stage: 'has_action_plan', underserved_community_relevance: 'medium',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'NEW ENTRANT — favorable in FY26 criteria. Has Vision Zero Action Plan. Joy has 33+ years at City of Boca Raton before Martin — potential bridge to another org in the CRM.',
    source: 'LinkedIn', created_at: '2026-04-22T10:00:00Z', updated_at: '2026-04-22T10:00:00Z',
  },
  {
    id: 'org-jta', organization_name: 'Jacksonville Transportation Authority',
    target_category: 'mpo', organization_type_detail: 'Regional Transit + Transportation Authority',
    website: 'https://www.jtafla.com', location_city: 'Jacksonville', location_state: 'FL', region: 'Southeast',
    notes: '700-person agency. $500M+ 10-year capital program. Greer Johnson Gillis is SVP / Chief Infrastructure & Development Officer. Former DDOT Deputy Director. White House Champion of Change (2014).',
    had_prior_ss4a_grant: 'unknown', has_action_plan: 'unknown', action_plan_type: 'unknown',
    ss4a_stage: 'likely_planning_candidate', underserved_community_relevance: 'high',
    pedestrian_safety_relevance: 'high', university_research_strength: 'not_applicable', grant_partner_fit: 'high',
    strategic_notes: 'VERY SENIOR contact. Duval County / Jacksonville region. City of Jacksonville (already in CRM) has $1.3M SS4A. JTA pincer alongside Matt Fall at City of Jacksonville.',
    source: 'LinkedIn', created_at: '2026-04-22T10:00:00Z', updated_at: '2026-04-22T10:00:00Z',
  },
]
...
export const SEED_CONTACTS: Contact[] = [
  ...
  // Wave 2026-04-16 to 2026-04-22
  {
    id: 'con-marohn', first_name: 'Amy', last_name: 'Marohn', full_name: 'Amy Marohn',
    title: 'Civil Engineering - Traffic', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-bloomington-mn',
    contact_type: 'engineer', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-16', next_action_date: '2026-04-23',
    notes: 'LINKEDIN 3rd-degree connection request sent April 16. 22 years at Bloomington MN. Liked an SS4A planning post — active signal.',
    source: 'LinkedIn', created_at: '2026-04-16T10:00:00Z', updated_at: '2026-04-16T10:00:00Z',
  },
  {
    id: 'con-farris', first_name: 'Jen', last_name: 'Farris', full_name: 'Jen Farris, MCRP/MPH',
    title: 'Transportation Planner, Office of Transit, Bicycle & Pedestrian Planning', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-dvrpc',
    contact_type: 'planner', seniority: 'medium', relationship_status: 'emailed',
    last_contact_date: '2026-04-16', next_action_date: '2026-04-23',
    notes: 'LINKEDIN sent April 16. UNC HSRC research background on nighttime pedestrian fatalities on urban arterials (AAA Foundation published). NC Vision Zero evaluation. MCRP/MPH dual degree. Philadelphia MPO role.',
    source: 'LinkedIn', created_at: '2026-04-16T10:00:00Z', updated_at: '2026-04-16T10:00:00Z',
  },
  {
    id: 'con-ledbetter', first_name: 'Lauren', last_name: 'Ledbetter', full_name: 'Lauren Ledbetter',
    title: 'Principal Transportation Planner — Bike/Ped Program Lead + Complete Streets', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-vta',
    contact_type: 'planner', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. 12+ years at VTA. Before that 8 years at Alta Planning & Design (major consultancy). Leads VTA Bike & Ped + Complete Streets delivery.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-sighamony', first_name: 'John', last_name: 'Sighamony', full_name: 'John Sighamony',
    title: 'Transportation Planner', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-vta',
    contact_type: 'planner', seniority: 'medium', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. Transportation Planner at VTA. Pincer alongside Lauren Ledbetter.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-owen', first_name: 'Jeff', last_name: 'Owen', full_name: 'Jeff Owen',
    title: 'Principal Planner, Transportation Planning', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-clackamas',
    contact_type: 'planner', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. Principal Planner at Clackamas County since Jul 2024. 9 years at TriMet (Active Transportation Planner → Senior Coord Strategic Planning). Former Bike/Ped Coordinator at City of Wilsonville. HDR consulting background.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-wilson-mighk', first_name: 'Mighk', last_name: 'Wilson', full_name: 'Mighk Wilson',
    title: 'Bicycle & Pedestrian Planner', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-metroplan-orlando',
    contact_type: 'planner', seniority: 'medium', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. Bike/Ped Planner at MetroPlan Orlando — org has $5.9M SS4A Action Plan.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-lacombe', first_name: 'Deb', last_name: 'LaCombe', full_name: 'Deb LaCombe',
    title: 'Senior Transportation Planner', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-yakima',
    contact_type: 'planner', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. Senior Transportation Planner at Yakima County WA. No prior county SS4A = new entrant potential.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-foster', first_name: 'Bennett', last_name: 'Foster', full_name: 'Bennett Foster, MPA, TDM-CP',
    title: 'Managing Director, Mobility Services', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-arc',
    contact_type: 'director', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. Managing Director at Atlanta Regional Commission since Jan 2025. Previously Dir Innovation + Partnerships. Atlanta Bicycle Coalition Policy Manager for 5 years. Bike/ped advocacy background.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-gandhi', first_name: 'Akshali', last_name: 'Gandhi', full_name: 'Akshali Gandhi, AICP',
    title: 'Former Senior Transportation Planner, City of Bellevue (SS4A grant manager)', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-bellevue',
    contact_type: 'planner', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN sent April 17. Managed $2.7M SS4A at Bellevue until May 2025. Fulbright Scholar on street design for kids. Formerly at King County Metro Transit. Deep inside-view of SS4A grant management.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-kleyman', first_name: 'Alexandra', last_name: 'Kleyman', full_name: 'Alexandra Kleyman, AICP',
    title: 'Vision Zero Program Manager, Boston Region MPO', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-bostonmpo',
    contact_type: 'program_manager', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-17', next_action_date: '2026-04-24',
    notes: 'LINKEDIN 1st-degree longer message sent April 17. Vision Zero Program Manager developing Boston MPO Action Plan. Previously MBTA Deputy Director Capital Investment. 3+ years at City of Somerville. FDOT walkability scorecard for elderly citizens work — direct WalkPhase fit. Used new direct question format.',
    source: 'LinkedIn', created_at: '2026-04-17T10:00:00Z', updated_at: '2026-04-17T10:00:00Z',
  },
  {
    id: 'con-freeman', first_name: 'Charles', last_name: 'Freeman', full_name: 'Charles Freeman, PE, PTP',
    title: 'Senior Planning Specialist, Division of Traffic Engineering & Operations', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-montgomery-md',
    contact_type: 'engineer', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-22', next_action_date: '2026-04-29',
    notes: 'LINKEDIN sent April 22. PE + PTP. Currently managing Road Safety Audit studies for Vision Zero High Injury Network + Safe Routes to School. Prior: Frederick County Traffic Engineer, Sabra Wang, Baltimore MC, MWCOG. Direct technical contact.',
    source: 'LinkedIn', created_at: '2026-04-22T10:00:00Z', updated_at: '2026-04-22T10:00:00Z',
  },
  {
    id: 'con-puerta', first_name: 'Joy', last_name: 'Puerta', full_name: 'Joy Puerta',
    title: 'Community Development Program Manager, CRA', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-martin-fl',
    contact_type: 'program_manager', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-22', next_action_date: '2026-04-29',
    notes: 'LINKEDIN sent April 22. 29 years experience. Currently Martin County CRA. Previously 5 years at Martin MPO — built Vision Zero Action Plan, Bike/Ped, Complete Streets. Before that 33+ years at City of Boca Raton (also in CRM). FAU alumna.',
    source: 'LinkedIn', created_at: '2026-04-22T10:00:00Z', updated_at: '2026-04-22T10:00:00Z',
  },
  {
    id: 'con-gillis', first_name: 'Greer', last_name: 'Johnson Gillis', full_name: 'Greer Johnson Gillis',
    title: 'SVP / Chief Infrastructure & Development Officer, JTA', email: '', phone: '',
    linkedin_url: '', organization_id: 'org-jta',
    contact_type: 'director', seniority: 'high', relationship_status: 'emailed',
    last_contact_date: '2026-04-22', next_action_date: '2026-04-29',
    notes: 'LINKEDIN sent April 22. SENIOR executive. 25+ years. Oversees Capital Engineering, Planning, Resources Development, Facilities, Sustainability — $500M+ 10-year capital program. Former DDOT Deputy Director. White House Champion of Change 2014. Profile explicitly mentions Vision Zero + innovative pedestrian solutions.',
    source: 'LinkedIn', created_at: '2026-04-22T10:00:00Z', updated_at: '2026-04-22T10:00:00Z',
  },
]
