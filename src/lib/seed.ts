...
export const SEED_PLAYBOOK: PlaybookTask[] = [
  // Day 1: Berkeley
  { id: 'task-001', day_date: '2026-03-31', organization_id: 'org-berkeley', status: 'pending', priority: 1,
  ...
  { id: 'task-002', day_date: '2026-03-31', organization_id: 'org-berkeley', status: 'pending', priority: 2,
  ...
  { id: 'task-003', day_date: '2026-03-31', organization_id: 'org-berkeley', status: 'pending', priority: 3,
  ...
  // Day 2: Georgia Tech
  { id: 'task-004', day_date: '2026-04-01', organization_id: 'org-gatech', status: 'pending', priority: 1,
  ...
  { id: 'task-005', day_date: '2026-04-01', organization_id: 'org-gatech', status: 'pending', priority: 2,
  ...
  { id: 'task-006', day_date: '2026-04-01', organization_id: 'org-gatech', status: 'pending', priority: 3,
  ...
  // Day 3: UT Austin + MIT
  { id: 'task-007', day_date: '2026-04-02', organization_id: 'org-utaustin', status: 'pending', priority: 1,
  ...
  { id: 'task-008', day_date: '2026-04-02', organization_id: 'org-utaustin', status: 'pending', priority: 2,
    suggested_action: 'Send initial outreach to UT Austin CTR researcher.',
    notes: '', template_id: 'tmpl-uni-initial', wave_id: 'wave-1' },
  { id: 'task-009', day_date: '2026-04-02', organization_id: 'org-mit', status: 'pending', priority: 3,
